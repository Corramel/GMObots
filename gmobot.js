...
var lengthOfIndex;
var questionArray = [];
var exampleArray = ["Golden Rice is also an example of a GME(me). Golden rice, which isn’t a naughty pun, has been modified in a way to have Vitamin A in it. Since most asian countries that primarily produced rice would have deficiency of that vitamin. "
, "Tomatoes ! Like potatoes but not with a P and has a T. Tomatoes are a prime example of GME(me)s since they have been genetically modified with a fish’s gene, aka a salmons gene, aka a cold water fish’s gene, to be more resistant to the cold. I guess you could say the tomatoes are a bit fishy."
`🌽! The corn we see is a benefit of GMOs; they produce more kernels, use less water, and have become resistant to bacteria and herbicides. However corny they might seem, these corn are bigger and badder than your typical corn. Do you want this puny piece of crap: http://www.chapala.com/chapala/magnifecentmexico/maiz/maiz_fullblock.jpg ?
Or do you want this big, bad, yellow piece of grainy goodness: http://images.wisegeek.com/ear-of-corn.jpg ? This corn has done more than gone to the hair salon to get that new do, this corn went to the lab and got some genes that help boost its resistance to bacteria and herbicides, and is more efficient with the water usage (I love a corn that learns to save money), but that doesn’t matter. Just look at the color and amount of kernels this corn has! Gee em oh <3! I think I’ve fallen for 🌽!
`];
